...
package net.theneophyte.sunstone.app.deskclock;
...
import net.theneophyte.sunstone.app.R;
import net.theneophyte.sunstone.app.deskclock.provider.Alarm;
import net.theneophyte.sunstone.app.deskclock.stopwatch.Stopwatches;
import net.theneophyte.sunstone.app.deskclock.timer.Timers;
import net.theneophyte.sunstone.app.deskclock.worldclock.CityObj;
import net.theneophyte.sunstone.app.deskclock.worldclock.db.DbCities;
import net.theneophyte.sunstone.app.deskclock.worldclock.db.DbCity;
...
public class Utils {
    ...
    public static final String DOC_AUTHORITY = "net.theneophyte.sunstone.app.providers.media.documents";
    public static final String DOC_DOWNLOAD = "net.theneophyte.sunstone.app.providers.downloads.documents";
    public static final String DOC_EXTERNAL = "net.theneophyte.sunstone.app.externalstorage.documents";
    ...
    **/
     ...
     * @hide
     */
    public static boolean isPathPrefixMatch(Uri path, Uri prefix) {
        if (!Objects.equals(path.getScheme(), prefix.getScheme()))
            return false;
        if (!Objects.equals(path.getAuthority(), prefix.getAuthority()))
            return false;

        List<String> seg = path.getPathSegments();
    ...
    public static String getTitleColumnNameForUri(Uri uri) {
        if (isPathPrefixMatch(uri, MediaStore.Audio.Playlists.EXTERNAL_CONTENT_URI)) {
...
//        if (defaultAlarm == null) {
            String defaultAlarm = ""; //If system prop isn't set return any alarm
//        }
