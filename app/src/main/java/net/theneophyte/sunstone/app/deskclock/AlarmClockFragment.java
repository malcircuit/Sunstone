...
import net.theneophyte.sunstone.app.deskclock.alarms.AlarmStateManager;
import net.theneophyte.sunstone.app.deskclock.provider.Alarm;
import net.theneophyte.sunstone.app.deskclock.provider.AlarmInstance;
import net.theneophyte.sunstone.app.deskclock.provider.DaysOfWeek;
import net.theneophyte.sunstone.app.deskclock.widget.ActionableToastBar;
import net.theneophyte.sunstone.app.deskclock.widget.TextTime;
...
//        }
    ...
    private void sendPickIntent() {
        if (mSelectSource == SEL_SRC_RINGTONE) {
            ...
            //intent.putExtra(RingtoneManager.EXTRA_RINGTONE_DIALOG_THEME, android.R.style.Theme_Material_Dialog);
            AlarmClockFragment.this.startActivityForResult(intent, REQUEST_CODE_RINGTONE);
        } else {
            final Intent intent = new Intent(Intent.ACTION_OPEN_DOCUMENT);
            intent.putExtra(RingtoneManager.EXTRA_RINGTONE_EXISTING_URI, AlarmClockFragment.this.mSelectedAlarm.alert);
            ...
            if (title == null) {
                if (uri.equals(AlarmMultiPlayer.RANDOM_URI)) {
                    ...
                    if (Utils.isRingToneUriValid(mContext, uri)) {
                        ...
                        } else if (Utils.isPathPrefixMatch(uri, MediaStore.Audio.Playlists.EXTERNAL_CONTENT_URI)) {
