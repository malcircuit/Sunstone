...
/**
 * Class to measure and draw the time in the {@link net.theneophyte.sunstone.app.deskclock.CircleTimerView}.
...
public class CountingTimerView extends View {
     ...
     * {@link net.theneophyte.sunstone.app.deskclock.CircleTimerView#onDraw(android.graphics.Canvas)}
     */
