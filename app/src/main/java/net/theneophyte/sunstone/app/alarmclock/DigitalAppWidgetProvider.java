...
package net.theneophyte.sunstone.app.alarmclock;
...
import net.theneophyte.sunstone.app.deskclock.worldclock.Cities;
import net.theneophyte.sunstone.app.deskclock.worldclock.CitiesActivity;
...
public class DigitalAppWidgetProvider extends AppWidgetProvider {
     ...
     **/
    public static final String ACTION_ON_QUARTER_HOUR = "net.theneophyte.sunstone.app.deskclock.ON_QUARTER_HOUR";
