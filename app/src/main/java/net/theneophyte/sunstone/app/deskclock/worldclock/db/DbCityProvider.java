...
package net.theneophyte.sunstone.app.deskclock.worldclock.db;
...
public class DbCityProvider extends ContentProvider {
    ...
    static {
        sURLMatcher.addURI("net.theneophyte.sunstone.app.deskclock.worldclock.db", "city", CITIES);
        sURLMatcher.addURI("net.theneophyte.sunstone.app.deskclock.worldclock.db", "city/#", CITIES_ID);
    }
